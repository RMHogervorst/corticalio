...
**Main points:** Main functions all work, You only have to put your api key in
.Renviron and corticalio will find it and use it in all calls. The bulk functions 
of the api do not yet work. I can't get the images to work and I haven't found 
a usefull way to transform the sparse matrix return in json format into a 
matrix object that is useful within R. Since I do not intend to continue
this project, feel free to fork and also feel free to contact me. I will
react to issues.
